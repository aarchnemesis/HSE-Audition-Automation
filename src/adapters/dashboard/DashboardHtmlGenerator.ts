    ...
    <div class="content-body">
      ...
      <div id="view-cockpit" class="tab-view active">
        ...
        <div class="cockpit-kpi-row">
          <div class="cockpit-kpi-card total" onclick="filterCockpitStatus('ALL')" style="cursor:pointer;" title="Ver todos os colaboradores do segmento ativo">
            <div class="cockpit-kpi-top">
              <span class="cockpit-kpi-label">Equipe Ativa</span>
            ...
            <div class="cockpit-kpi-sub">Total no segmento</div>
          </div>
