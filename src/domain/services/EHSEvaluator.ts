...
export class EHSEvaluator {
   ...
   *  - VENCIDO  (<= 0 dias)
   */
  static evaluateDate(expirationDate: Date | null | undefined, refDate: Date = new Date()): { status: EHSStatus; detail: string } {
  ...
  static calculateExpirationFromIssue(issueDate: Date, validityYears: number): Date {
