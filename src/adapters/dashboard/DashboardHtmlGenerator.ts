...
<head>
  ...
  <title>arthnex | EHS & DO Training Matrix Dashboard</title>
  <link rel="preconnect" href="https://fonts.googleapis.com">
  <link rel="preconnect" href="https://fonts.gstatic.com" crossorigin>
  <link href="https://fonts.googleapis.com/css2?family=Inter:wght@400;500;600;700;800&family=JetBrains+Mono:wght@500;600;700&display=swap" rel="stylesheet">
  <style>
    /* ==========================================================================
       ARTHNEX CORPORATE DESIGN SYSTEM - HSE & DO TRAINING MATRIX
       ========================================================================== */
    :root {
      --sidebar-bg: #090D16;
    ...
    * { box-sizing: border-box; margin: 0; padding: 0; }
    ...
    .arthnex-logo span { color: var(--brand-cyan); }
...
<body>
  ...
  <aside class="sidebar">
    <div class="sidebar-brand">
      <div class="arthnex-logo">arth<span>nex</span></div>
  ...
  <main class="main-viewport">
    ...
    <div class="topbar">
      <div class="breadcrumb-wrap">
        ...
        <div class="breadcrumb-pill">DO &amp; Treinamentos &gt; Skill Matrix &amp; EHS Compliance</div>
      </div>
    ...
    <div class="page-title-bar">
      ...
      <div class="mono" style="font-size: 11px; font-weight: 700; color: var(--text-muted);">
        STATUS: <span style="color: var(--brand-green); font-weight: 800;">AUDITADO EM 28/08/2026</span>
      </div>
    </div>
